...
from PyQt5.QtGui import QPixmap, QPainter, QColor, QBrush, QCursor, QIcon, QDesktopServices
from PyQt5.QtCore import Qt, QRectF, QTimer, QPointF, QUrl
...
MOBILE_URL = "https://github.com/omjimmy10/OmnigraphCodex/tree/main"
...
class AudioToImageConverter(QMainWindow):
    def __init__(self):
        ...
        self.dark_mode = True  # The refreshed UI uses the OmnigraphCodex dark theme by default
    ...
    def setup_ui(self):
        ...
        # Mobile link button, kept in the original top-right button position.
        self.dark_mode_btn = QPushButton("OmnigraphCodex for Mobile")
        self.dark_mode_btn.clicked.connect(self.open_mobile_link)
        ...
        self.scene.setBackgroundBrush(QBrush(QColor("#03070D")))
    ...
    def show_read_me(self):
        ...
        <body>
            ...
            &#128308; <b>Method A</b> &ndash; Stores different parts of the audio in Red, Green, and Blue channels sequentially.<br>
            &#128309; <b>Method B</b> &ndash; Interweaves audio data into all channels in each pixel simultaneously.<br>
            &#128994; <b>Method C</b> &ndash; Uses frequency spectrum analysis to distribute the audio across the image.<br><br>
    ...
    def apply_dark_title_bar(self):
        ...
        try:
            ...
            pass
    def open_mobile_link(self):
        QDesktopServices.openUrl(QUrl(MOBILE_URL))

    def apply_omni_theme(self):
        self.setStyleSheet("""
            QMainWindow {
            ...
            QPushButton {
                background-color: rgba(68, 143, 255, 0.10);
                color: #448FFF;
            ...
            QPushButton:hover {
                background-color: rgba(68, 143, 255, 0.18);
                border-color: #26FF7E;
                color: #26FF7E;
            }
            QPushButton:pressed {
                background-color: rgba(38, 255, 126, 0.18);
                color: #26FF7E;
            }
            ...
            QComboBox {
                ...
                border-radius: 3px;
                padding: 4px 8px;
                selection-background-color: #0B1522;
            }
            QComboBox:hover {
                border-color: #448FFF;
            }
        ...
        """)
        self.graphics_view.setStyleSheet("background-color: #03070D; border: 1px solid #26FF7E;")
        self.read_me_btn.setStyleSheet("color: #9CA8B8; border-color: #253140; background-color: #07101A;")
        self.dark_mode_btn.setStyleSheet("color: #9CA8B8; border-color: #253140; background-color: #07101A;")
